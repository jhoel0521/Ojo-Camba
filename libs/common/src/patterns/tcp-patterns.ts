export const TCP_PATTERNS = {
  ...
  ADMIN: {
    ...
    GET_CONTEXTO_OPERATIVO: 'admin.get_contexto_operativo',
    LIST_VISITAS_TECNICO: 'admin.list_visitas_tecnico',
    LIST_VISITAS_CUADRILLA: 'admin.list_visitas_cuadrilla',
    GET_VISITA_TECNICO: 'admin.get_visita_tecnico',
    ASIGNAR_VISITA_TECNICO: 'admin.asignar_visita_tecnico',
